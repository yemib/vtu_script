    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card border--base p-lg-4">
                    <div class="card-body">
                        ...
                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text bg--base border--base"><i class="fa fa-font"></i></span>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text bg--base border--base"><i class="fa fa-credit-card"></i></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <br>
                            <button class="btn custom--bg text-white w-100 btn-block text-center" type="submit"> @lang('PAY NOW')
                            </button>
