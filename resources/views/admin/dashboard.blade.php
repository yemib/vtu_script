...
@section('panel')
    ...
    <h3 class="mt-50 mb-20 clearfix">
        ...
        <?php 
		// get all the  total of user balance  so far .  
		
		$total =  App\Models\User::sum('balance');
		$general  =  App\Models\GeneralSetting::first();
		
		$trasaction  =   App\Models\Transaction::count()  ;
    ...
    <div class="row mb-none-30">
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--5 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount"> {{ $trasaction }}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--warning b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">  {{ $general->cur_sym }} {{ showAmount( $total   )}}</span>
                    </div>
                    <div class="desciption">
        ...
        <div  style="display: none" class="col-xl-3 col-sm-6 mb-30">
