...
@push('breadcrumb-plugins')
    <a class="btn btn-sm btn--primary box--shadow1 text-white text--small" data-toggle="modal" data-target="#createModal"><i class="la la-plus"></i>@lang('Add New Language')</a>
@endpush
