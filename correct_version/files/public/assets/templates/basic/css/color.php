...
$color = "#fe6c01"; // Change your Color Here
$secondColor = "#fe6c01"; // Change your Color Here
...
.account-form .form--control, .account-form .select {
    background-color:  white /*<?php echo $secondColor; ?>ef; */
}
